...
$itadminroles="'1'";
  $itadmin="{
                    text:'Cancel',
                    tooltip:'Clear Queue',
                    iconCls:'cancelqueues',
					handler:function(){
					removeQueedItemsOnconfirmation();
					}
                },'-',
                {
                    text:'Manage Users',
 ...
 //// 
  var myviewport=  new Ext.Viewport({ 
			   ...
			   tbar:[
         {
					...
					handler:function(){sendEmailBills();}
                 },'-',
         {
                    text:'Check Balance',
...
function removeQueedItemsOnconfirmation(tbl,datasource) {
    ...
    Ext.Msg.confirm('Clear SMS Queue', 'Are you sure you want to clear SMS Queue?', 
	function (id, value) {
            if (id === 'yes') {
			cancelQueuedSMS(tbl);
...
function sendQueuedSMSByType(tbl,datasource) {
    Ext.Msg.confirm('Send SMS Batch', 'Are you sure you want to Send  Queue SMS?', 
	function (id, value) {
            if (id === 'yes') {
			//JBNJP-+(tbl);
            SendBatchSMSs(tbl);
