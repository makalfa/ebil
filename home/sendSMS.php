...
$campanyDetail=fillPrimaryData('admin_company',1);
 ...
 if($typeSource=='sms_billhandle')
	$qry="SELECT billhandle_id,connection_number, phone_number, amount, pay_before,sys_track
   ...
   if($commtypeArray[0]=='disconnection'){
            ...
            $smsArrayDetails=fillPrimaryData('sms_smsmsgcust',2);
        ...
        if($commtypeArray[0]=='bill'||$commtypeArray[0]=='3bill'){
      				$smsArrayDetails=fillPrimaryData('sms_smsmsgcust',1);

                   if($commtypeArray[0]=='3bill') $smsArrayDetails=fillPrimaryData('sms_smsmsgcust',3);
				...
				if($generalMessage)	$message=$generalMessage;
