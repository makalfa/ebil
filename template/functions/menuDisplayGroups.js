...
function savemenudisplyOptionssms_billhandle(){
var sms_billhandle1=document.getElementById('sms_billhandle1');
sms_billhandle1value="Hide";
if(sms_billhandle1.checked==true){
	sms_billhandle1value="Show";
	}
var sms_billhandle2=document.getElementById('sms_billhandle2');
var sms_billhandle3=document.getElementById('sms_billhandle3');
var sms_billhandle4=document.getElementById('sms_billhandle4');
var xmlHttp;
	try{	
		xmlHttp=new XMLHttpRequest();// Firefox, Opera 8.0+, Safari
	}
...
xmlHttp.open("GET","http://localhost/formgen/home/saveMenuOptions.php?displaydiv=updatestatus"+'&t='+'sms_billhandle'+'&sms_billhandle1='+sms_billhandle1value
+'&sms_billhandle2='+sms_billhandle2.value
+'&sms_billhandle3='+sms_billhandle3.value
+'&sms_billhandle4='+sms_billhandle4.value
,true);
xmlHttp.send(null);
}
