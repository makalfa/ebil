<?php
						...
						";
						$_SESSION["payment_student_SearchSQL"]="
						
						select payment_student.student_id , payment_student.amount , payment_student.description , payment_student.created_by , payment_student.date_created , payment_student.changed_by , payment_student.date_changed , payment_student.voided , payment_student.voided_by , payment_student.date_voided , payment_student.uuid , payment_student.sys_track  from payment_student
						...
						select sms_billhandle.billhandle_id , sms_billhandle.connection_number , sms_billhandle.amount , sms_billhandle.phone_number , sms_billhandle.pay_before , sms_billhandle.created_by , sms_billhandle.date_created , sms_billhandle.changed_by , sms_billhandle.date_changed , sms_billhandle.voided , sms_billhandle.voided_by , sms_billhandle.date_voided , sms_billhandle.uuid , sms_billhandle.sys_track  from sms_billhandle
						...
						select sms_disconnschedule.disconnschedule_id , sms_disconnschedule.disconnschedule_name , sms_disconnschedule.schedule_description , sms_disconnschedule.bill_date , sms_disconnschedule.due_after , sms_disconnschedule.file_brouwse , sms_disconnschedule.created_by , sms_disconnschedule.date_created , sms_disconnschedule.changed_by , sms_disconnschedule.date_changed , sms_disconnschedule.voided , sms_disconnschedule.voided_by , sms_disconnschedule.date_voided , sms_disconnschedule.uuid , sms_disconnschedule.sys_track  from sms_disconnschedule
						
						";
						$_SESSION["sms_emailhandle_SearchSQL"]="
						
						select sms_emailhandle.emailhandle_id , sms_emailhandle.connection_number , sms_emailhandle.amount , sms_emailhandle.email_address , sms_emailhandle.pay_before , sms_emailhandle.created_by , sms_emailhandle.date_created , sms_emailhandle.changed_by , sms_emailhandle.date_changed , sms_emailhandle.voided , sms_emailhandle.voided_by , sms_emailhandle.date_voided , sms_emailhandle.uuid , sms_emailhandle.sys_track  from sms_emailhandle
						
						";
						$_SESSION["sms_emailschedule_SearchSQL"]="
						
						select sms_emailschedule.emailschedule_id , sms_emailschedule.emailschedule_name , sms_emailschedule.schedule_description , sms_emailschedule.bill_date , sms_emailschedule.due_after , sms_emailschedule.file_brouwse , sms_emailschedule.created_by , sms_emailschedule.date_created , sms_emailschedule.changed_by , sms_emailschedule.date_changed , sms_emailschedule.voided , sms_emailschedule.voided_by , sms_emailschedule.date_voided , sms_emailschedule.uuid , sms_emailschedule.sys_track  from sms_emailschedule
						...
						select sms_invalidemailaddress.invalidemailaddress_id , sms_invalidemailaddress.connection_number , sms_invalidemailaddress.amount , sms_invalidemailaddress.email_address , sms_invalidemailaddress.pay_before , sms_invalidemailaddress.created_by , sms_invalidemailaddress.date_created , sms_invalidemailaddress.changed_by , sms_invalidemailaddress.date_changed , sms_invalidemailaddress.voided , sms_invalidemailaddress.voided_by , sms_invalidemailaddress.date_voided , sms_invalidemailaddress.uuid , sms_invalidemailaddress.sys_track  from sms_invalidemailaddress
						...
						select sms_processedemail.processedemail_id , sms_processedemail.email_address , sms_processedemail.connection_number , sms_processedemail.message , sms_processedemail.created_by , sms_processedemail.date_created , sms_processedemail.changed_by , sms_processedemail.date_changed , sms_processedemail.voided , sms_processedemail.voided_by , sms_processedemail.date_voided , sms_processedemail.uuid , sms_processedemail.sys_track  from sms_processedemail
						
						";
						$_SESSION["sms_processedfailedemail_SearchSQL"]="
						
						select sms_processedfailedemail.processedfailedemail_id , sms_processedfailedemail.email_address , sms_processedfailedemail.connection_number , sms_processedfailedemail.message , sms_processedfailedemail.reason_failed , sms_processedfailedemail.created_by , sms_processedfailedemail.date_created , sms_processedfailedemail.changed_by , sms_processedfailedemail.date_changed , sms_processedfailedemail.voided , sms_processedfailedemail.voided_by , sms_processedfailedemail.date_voided , sms_processedfailedemail.uuid , sms_processedfailedemail.sys_track  from sms_processedfailedemail
						...
						select sms_schedule.schedule_id , sms_schedule.schedule_name , sms_schedule.schedule_description , sms_schedule.bill_date , sms_schedule.due_after , sms_schedule.file_brouwse , sms_schedule.created_by , sms_schedule.date_created , sms_schedule.changed_by , sms_schedule.date_changed , sms_schedule.voided , sms_schedule.voided_by , sms_schedule.date_voided , sms_schedule.uuid , sms_schedule.sys_track  from sms_schedule
						
						";
						$_SESSION["sms_schedulegeneralsms_SearchSQL"]="
						
						select sms_schedulegeneralsms.schedulegeneralsms_id , sms_schedulegeneralsms.schedulegeneralsms_name , sms_schedulegeneralsms.schedule_description , sms_schedulegeneralsms.file_brouwse , sms_schedulegeneralsms.created_by , sms_schedulegeneralsms.date_created , sms_schedulegeneralsms.changed_by , sms_schedulegeneralsms.date_changed , sms_schedulegeneralsms.voided , sms_schedulegeneralsms.voided_by , sms_schedulegeneralsms.date_voided , sms_schedulegeneralsms.uuid , sms_schedulegeneralsms.sys_track  from sms_schedulegeneralsms
						...
						select sms_smsinvalid.smsinvalid_id , sms_smsinvalid.connection_number , sms_smsinvalid.amount , sms_smsinvalid.phone_number , sms_smsinvalid.pay_before , sms_smsinvalid.created_by , sms_smsinvalid.date_created , sms_smsinvalid.changed_by , sms_smsinvalid.date_changed , sms_smsinvalid.voided , sms_smsinvalid.voided_by , sms_smsinvalid.date_voided , sms_smsinvalid.uuid , sms_smsinvalid.sys_track  from sms_smsinvalid
						
						";
						$_SESSION["sms_smsmsgcust_SearchSQL"]="
						
						select sms_smsmsgcust.smsmsgcust_id , sms_smsmsgcust.message , sms_smsmsgcust.status , sms_smsmsgcust.created_by , sms_smsmsgcust.date_created , sms_smsmsgcust.changed_by , sms_smsmsgcust.date_changed , sms_smsmsgcust.voided , sms_smsmsgcust.voided_by , sms_smsmsgcust.date_voided , sms_smsmsgcust.uuid , sms_smsmsgcust.sys_track  from sms_smsmsgcust
