...
drop table sms_billhandle ;
drop table sms_billhandleoaf ;
...
$_SESSION["sms_smsinvalid_SearchSQL______________"]="
...
$_SESSION["sms_smsinvalid_SearchSQL"]="
						select distinct sms_smsinvalid.connection_number , sms_smsinvalid.phone_number  from sms_smsinvalid
						  where sms_smsinvalid.connection_number<>''
						  and sms_smsinvalid.connection_number not like '%consumer%'
						   and sms_smsinvalid.connection_number not like '%@%'
						     and sms_smsinvalid.phone_number not like '%@%'
							 and sms_smsinvalid.phone_number not like '%#%'
							 and sms_smsinvalid.phone_number not like '%{%'
                          and date_created>'2013-12-31'
						  order by sms_smsinvalid.connection_number, date_created
